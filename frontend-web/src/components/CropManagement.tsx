                ...
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
                  {crop.status === 'ACTIVE' && (
                    <button
                      ...
                      className="p-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-xl transition-colors text-xs font-bold flex items-center gap-1"
          ...
          <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl p-6 text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={harvesting}
                className="flex-1 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl transition-colors text-sm flex items-center justify-center"
              >
